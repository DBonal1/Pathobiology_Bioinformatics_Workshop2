...
#SBATCH -o /users/dbonal/scratch/Workshop2/slurms/SLURM_17_MultiQC_Complete_%j.out
...
mkdir /users/dbonal/scratch/Workshop2/FINAL_QC

# Set Directory to this compiled QC folder
cd /users/dbonal/scratch/Workshop2/FINAL_QC

### Create Path to QC folder 
Path_To_QC=/users/dbonal/scratch/Workshop2/QC
### Create Path to STAR Alignment folder (you will be targeting the Log.final.out files)
Path_To_STAR=/users/dbonal/scratch/Workshop2/STAR_Alignment_Output
###Create Path to FeatureCount folder (you will be targeting the txt.summary files)
Path_To_STARCounts=/users/dbonal/scratch/Workshop2/STAR_Alignment_Output/Counts
### Create Path to SALMON Alignment folder
Path_To_SALMON=/users/dbonal/scratch/Workshop2/Salmon_Alignment_Output
